...
>[!profile-card-inf|noborder]
> ```dataviewjs
>let nofold = '!"01-Template" and !"03-Attachment" and !"50-Inbox" and #book or #Movie'
...
>> 
>> 距春节还有<%+* let edate = moment("2025-02-10", "yyyy-MM-DD"); let from = moment().startOf('day'); edate.diff(from, "days") >= 0 ? tR += edate.diff(from, "days") : tR += edate.add(1, "year").diff(from, "days") %> 天
...
return contents;}
let reg=/[\u4e00-\u9fa5]/
let nofold = '!"01-Template" and !"03-Attachment" and !"50-Inbox" and !"20-Diary"';
let files = dv.pages(nofold).file;
...
color: 99,188,76
> “Common actions”
- Ⓜ️ [生成MOC](obsidian://advanced-uri?commandid=templater-obsidian%253A01-Template%252Ftp_foldermoc-Include-subfolders.md)
